...
@section('content')
    <div class="box box-warning">
        ...
        <!-- form start -->
        <form class="form-horizontal" action="{{ URL('site/role/'.$role->id) }}" method="POST">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name="desc" rows="10" class="form-control" required="required">{{ $role->description }}</textarea>
                    </div>
                </div>
            </div><!-- /.box-body -->
