...
@section('content')
    <section class="lsdd-main">
        <div class="hd po-f">
            ...
            <div id="go_home" style="position: absolute;left: 5px; top: -5px;"><img src="/images/nav5.png" width="30px" height="30px"></div>
            <div id="refresh" style="position: absolute;right: 5px; top: -5px;"><img src="/images/refresh-simple.png" width="30px" height="30px"></div>
        </div>
