                    ...
                    @if($collects)
                        @foreach($collects as $consult)
                            <div class="itms">
                                ...
                                <div class="right">
                                    <h3 class="chaochu_1 mar-top-5"><span class="fc-03aaf0">{{$consult->seller->real_name}} 律师</span>　　{{$consult->category->name}}</h3>
                                    <p class=" fc-03aaf0 mar-top-5">咨询费：{{$consult->price}}元</p>
                                </div>
