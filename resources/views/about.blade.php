...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="about-p1">律屋律师分布图</div>
        <div class="about-img1 te-cen"><img src="/images/30.jpg"></div>
        <div class="about-pp">
            <h3 class="t1">老百姓的律师品牌</h3>
            <p class="font2" style="margin-bottom: -50px;">身处互联网时代的今天，并没有一家律师平台深入人心，而打造一个这样的品牌成为了我们公司和平台律师共同的目标。律屋是律师和用户的家,律屋团队更多的就是全方位服务律师和咨询用户。律屋对律师严格筛选，并对非诚信律师零容忍。当您聘请平台律师进行法律咨询服务时，律屋不会让您失望，您将获得一个极致的服务体验。</p>
        </div>
        {{--<div class="about-sp">--}}
